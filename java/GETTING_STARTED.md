# Getting Started with Median of a List of Lists (with no concatenation) kata in Java
...
Run all the tests in the [MedianListOfListsTest](./src/test/java/com/murex/MedianListOfListsTest.java)
class.
...
3. From the terminal navigate to [Kata-MedianListOfLists/java]() directory
